...
<div class="pd-20">
	...
	<span class="l"> 
	<%-- <a href="javascript:;" onclick="member_add('添加基本信息','${baseurl}engine/engineBasicInfoAddAsEngineName.action?id=${engineId}','1200','810')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加基本信息</a>
	 --%></span> <span class="r">共有数据：<strong>${countengineTestBasicList}</strong> 条</span> </div>
	<div class="mt-20">
