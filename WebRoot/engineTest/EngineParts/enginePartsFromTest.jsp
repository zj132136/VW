...
<div class="pd-20">
	<div class="text-c"> 日期范围：
		...
		-
		<input type="text" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})" id="datemin" class="input-text Wdate" style="width:180px;">
	 	<input type="text" class="input-text" style="width:250px" placeholder="输入发动机零部件" id="" name="">
		<button type="submit" class="btn btn-success radius" id="" name=""><i class="Hui-iconfont">&#xe665;</i> 搜发动机零部件</button>
	</div>
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l">
	<a href="javascript:;" onclick="member_add('添加零部件信息','${baseurl}engine/enginePartsAdd.action?engineId=${engineId}','1000','550')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加零部件信息</a>
	 </span> <span class="r">共有数据：<strong>${countEnginePartslist}</strong> 条</span> </div>
	<div class="mt-20">
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<c:forEach items="${enginePartslist}" var="item">
			...
			<td class="td-manage">
			 <a title="编辑" href="javascript:;" onclick="admin_edit('发动机位置编辑','${baseurl}engine/enginePartsEdit.action?id=${item.id}','2','800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
