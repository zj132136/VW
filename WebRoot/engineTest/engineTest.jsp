...
<div class="pd-20">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"> <a href="javascript:;" onclick="member_add('添加履历','member-add.html','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加履历</a></span> <span class="r">共有数据：<strong>88</strong> 条</span> </div>
	<div class="mt-20">
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<thead>
			<tr>
				<th scope="col" colspan="7" class="text-c">履历管理</th>
			...
			<tr class="text-c">
				...
				<th width="40">基本信息</th>
				<th width="40">试验信息</th>
				<th width="40">发动机零部件</th>
				<th width="40">机油消耗</th>
				<th width="40">机油压力</th>
				<th width="40">缸压</th>
				<th width="40">氮气泄露</th>
				<th width="40">增压器测量</th>
				<th width="100">操作</th>
			</tr>
			<tbody>
			<tr class="text-c">
				...
				<td><u style="cursor:pointer" class="text-primary" onclick="member_show('张三','member-show.html','10001','360','400')">AF-QM-TI-005</u></td>
				<td><u style="cursor:pointer" class="text-primary" onclick="member_show('张三','member-show.html','10001','360','400')">TIPST1</u></td>	
				<td><u style="cursor:pointer" class="text-primary" onclick="member_show('张三','member-show.html','10001','360','400')">FT.1</u></td>
				<td ><u style="cursor:pointer" class="text-primary" onclick="member_show('张三','member-show.html','10001','360','400')">备件</u></td>
