...
<body class="gray-bg">
    <div class="wrapper wrapper-content">
		...
		<c:forEach items="${oilConsumptionlist}" var="item">
			...
			<td class="td-manage">
			 <a title="编辑" href="javascript:;" onclick="admin_edit('${item.engineName}','${baseurl}engine/oilConsumptionEdit.action?id=${item.id}','2','1200','800')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
