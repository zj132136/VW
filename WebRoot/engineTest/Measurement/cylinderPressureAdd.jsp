...
<body>
<div class="pd-20">
	<form action="${pageContext.request.contextPath }/engine/cylinderPressureAddSubmit.action"  method="post" class="form form-horizontal" onSubmit="return closeWindow()"  >
		...
		<div class="row cl">
			...
			<div class="formControls col-2"> 
				<input type="text" class="input-text" value="${time}" id="cylinderPressureTime" name="cylinderPressureTime" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})">
			</div>
		...
		<div class="hr-line-dashed"></div>
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>cylinder1：</label>
			<div class="formControls col-2"> 
		...
		<div class="row cl">
			...
			<div class="formControls col-2"> 
				<input type="checkbox" class="js-switch" id="results" name="results" checked />
			</div>
		</div>
