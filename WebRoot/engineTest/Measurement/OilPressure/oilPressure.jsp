...
<body class="gray-bg">
    <div class="wrapper wrapper-content">
        <div class="row">
            ...
            <div class="col-sm-9 animated fadeInRight">
                    ...
                    <nav class="breadcrumb">
					 ...
					 <span class="l"> </span> <span class="r">共有数据：<strong>${countOilPressureList}</strong> 条</span> </div>
					<div class="mt-20">
		...
		<c:forEach items="${oilPressureList}" var="item">
			...
			<td class="td-manage">
			 <a title="编辑" href="javascript:;" onclick="admin_edit('${item.engineName}','${baseurl}engine/oilPressureEdit.action?engineName=${item.engineName}&testName=${item.testName}','2','1200','800')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
