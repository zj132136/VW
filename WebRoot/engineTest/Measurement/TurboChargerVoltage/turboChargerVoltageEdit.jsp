...
<div class="pd-20">
	<form action="${pageContext.request.contextPath }/engine/engineBasicUpdateSubmit.action"  method="post" class="form form-horizontal"  onSubmit="return closeWindow()">
		<input type="text" class="hidden"  id="engineId" name="engineId" value="${turboChargerVoltage.engineId}">
		<input type="text" class="hidden"  id="locationId" name="locationId" value="${turboChargerVoltage.locationId}">
		<input type="text" class="hidden"  id="addByUser" name="addByUser" value="${username}">
		<input type="text" class="hidden"  id="id" name="id" value="${turboChargerVoltage.id}">
		<h4>About</h4>
		<div class="hr-line-dashed"></div>
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>日期：</label>
			<div class="formControls col-2"> 
				<input type="text" class="input-text" value="${turboChargerVoltage.turboChargerVoltageTime}" id="oilConsumptionTime" name="oilConsumptionTime" >
			</div>
			<label class="form-label col-2">试验：</label>
			<div class="formControls col-2">
				<input type="text" class="input-text" value="${turboChargerVoltage.testName}" placeholder="" id="testName" name="testName" >
			</div>
			<label class="form-label col-2">操作人员：</label>
			<div class="formControls col-2">
				<input type="text" class="input-text" value="${turboChargerVoltage.operator}" placeholder="" id="operator" name="operator" >
			</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-2"> 
				<input type="text" class="input-text" value="${turboChargerVoltage.cycleTime}" placeholder="" id="cycleTime" name="cycleTime" >
			</div>
			<label class="form-label col-2">总时间：</label>
			<div class="formControls col-2">
				<input type="text" class="input-text" value="${turboChargerVoltage.totalTime}" placeholder="" id="totalTime" name="totalTime" >
			</div>
			<label class="form-label col-2">维修类型：</label>
			<div class="formControls col-2">
				<input type="text" class="input-text" value="${turboChargerVoltage.maintenanceTpye}" placeholder="" id="maintenanceTpye" name="maintenanceTpye" >
			</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-2">
				<input type="text" class="input-text" value="${turboChargerVoltage.turboManufacturer}"  id="turboManufacturer" name="turboManufacturer" >
			</div>
		</div>
		<div class="row cl">
