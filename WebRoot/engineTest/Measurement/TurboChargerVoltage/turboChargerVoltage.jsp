...
<body class="gray-bg">
    <div class="wrapper wrapper-content">
            ...
            <div class="col-sm-9 animated fadeInRight">
                    ...
                    <nav class="breadcrumb">
                       ...
                       <%-- <span class="col-sm-2">
						...
						<button type="submit" class="btn btn-success radius" id="" name=""><i class="Hui-iconfont">&#xe665;</i> 搜电压</button>
					</div>
		...
		<c:forEach items="${turboChargerVoltageList}" var="item">
			...
			<td class="td-manage">
			 <a title="编辑" href="javascript:;" onclick="admin_edit('${item.engineName}','${baseurl}engine/turboChargerVoltageEdit.action?id=${item.id}','2','1200','600')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
