...
<body>
<div class="pd-20">
	<form action="${pageContext.request.contextPath }/engine/engineEditSubmit.action"  method="post" class="form form-horizontal" id="form-admin-add" onSubmit="return closeWindow()" >
		<input type="hidden" name="engineId" value="${engine.engineId}">
		<div class="row cl">
			<label class="form-label col-3"><span class="c-red">*</span>位置名称：</label>
			<div class="formControls col-5">
				<input type="text" class="input-text"  placeholder="" id="engineName" name="engineName" datatype="*2-16" nullmsg="位置名称不能为空" value="${engine.engineName}"  >
			</div>
			<div class="col-4"> </div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text" class="input-text"  id="addByUser" name="addByUser"   value="${engine.addByUser}"  >
