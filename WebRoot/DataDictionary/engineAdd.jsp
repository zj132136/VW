...
<%
String path = request.getContextPath()+"/"+"engine/engineList.action";
...
<body>
<div class="pd-20">
	<form action="${pageContext.request.contextPath }/engine/engineAddSubmit.action"  method="post" class="form form-horizontal" id="form-admin-add" onSubmit="return closeWindow()">
		<div class="row cl">
			<label class="form-label col-3"><span class="c-red">*</span>发动机名称：</label>
			<div class="formControls col-5">
				<input type="text" class="input-text"  placeholder="" id="engineName" name="engineName" datatype="*2-16" nullmsg="位置名称不能为空"   >
			</div>
			<div class="col-4"> </div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-5">
				<%-- <input type="text" class="input-text" id="addby" name="addby"  value="${username}"> --%>
				<input type="text" class="input-text"  placeholder="" id="addByUser" name="addByUser" datatype="*2-16" nullmsg="位置名称不能为空" value="${username}"  >
		...
		<div class="row cl">   
			...
			<div class="formControls col-5">       
               <input class="input-text" id="addDatetime" name="addDatetime" placeholder="YYYY-MM-DD hh:mm:ss" onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})"  value="${time}">
            </div>
        </div>
		<div class="row cl">
