...
<body>
<div class="pd-20">
	<form action="${pageContext.request.contextPath }/engine/engineLocationAddSubmit.action"  method="post" class="form form-horizontal" id="form-admin-add" onSubmit="return closeWindow()">
		...
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text" class="input-text" id="add_by" name="add_by" placeholder="" value="${username}">
				<%-- <input type="hidden" id="add_by" name="add_by" value="${username}"/> --%>
			</div>
		...
		<%-- <div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text" class="input-text"  placeholder="" id="add_datetime" name="add_datetime" datatype="*2-16" nullmsg="台架名称不能为空" value="${engine.add_datetime}"  >
			</div>
			<div class="col-4"> </div>
		</div> --%>
		<div class="row cl">   
